...
[An early sample](http://bdulac.github.io/sample/polymeria) is available. If you want to test, just clone the repository and have a look at the *sample.html* file.